    ...
    $( '#main-btn' ).click(function() {
        ...
        $.getJSON(url, function(data) {
            ...
            if (typeof data.results === "undefined") {
                ...
                let result = '<p><a target="_blank" title="Ver producto en Mercado Libre" href="'+randomItems[0].permalink+'""><img src="'+randomItems[0].thumbnail+'" class="product-img"></a></p>';
                ...
                if(randomItems[0].listing_type == 'gold_pro') { result += '<p class="listing_type">Cuotas sin interés</p>'; }
                
                result += '<a target="_blank" title="Ver producto en Mercado Libre" href="'+randomItems[0].permalink+'" class="w-100 btn btn-lg btn-primary mb-3">¡Lo quiero!</a>';
                result += '<p class="divider"></p>'
                
                let tweet = '¿No sabes qué comprar o regalar?';
                tweet += ' 📦 📦 Buscá tu próxima compra random de Mercado Libre en 👇 ';
                
                $('#share').html('<a class="twitter-share-button" title="Compartir en Twitter!" href="https://twitter.com/intent/tweet" data-size="large"  data-url="https://chcibelli.github.io/shake-n-buy/" data-text="'+tweet+'">Tweet</a>');
                twttr.widgets.load();
